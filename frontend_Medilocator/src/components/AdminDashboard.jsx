            ...
            <div className="col-md-4 col-sm-6">
              <div className="card text-bg-warning shadow-sm h-100">
                <div className="card-body text-center">
                  ...
                  <p className="card-text fs-5">Low Stock</p>
                </div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6">
              <div className="card text-bg-secondary shadow-sm h-100">
                <div className="card-body text-center">
                  ...
                  <p className="card-text fs-5">Out of Stock</p>
                </div>
              </div>
            </div>
             <div className="col-md-4 col-sm-6">
              <div className="card text-bg-danger shadow-sm h-100">
                <div className="card-body text-center">
                  ...
                  <p className="card-text fs-5">Expired Products</p>
                </div>
              </div>
            </div>
             <div className="col-md-4 col-sm-6">
              <div className="card text-bg-info shadow-sm h-100">
                <div className="card-body text-center">
                  ...
                  <p className="card-text fs-5">Expiring Soon</p>
                </div>
              </div>
            </div>
          </div>
